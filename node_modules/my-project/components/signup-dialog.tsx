...
export function SignUpDialog({ open, onOpenChange, onOpenLogin }: SignUpDialogProps) {
  ...
  const handleCheckUsername = async () => {
    ...
    if (username.length < 2) {
      setUsernameHint("아이디는 2자 이상 입력해 주세요.");
      resetUsernameCheck();
      return;
    }
    ...
    try {
      ...
      resetUsernameCheck();
      setUsernameHint(e instanceof Error ? e.message : "중복 확인에 실패했습니다.");
    } finally {
      ...
      <DialogContent className="border-border bg-card sm:max-w-md">
        ...
        >
          ...
          <div className="space-y-2">
            ...
            {usernameHint && (
              <p
                className={cn(
                  "text-xs",
                  usernameAvailable ? "text-accent" : "text-muted-foreground",
                  usernameChecked && !usernameAvailable && "text-destructive",
                )}
              >
                {usernameHint}
              </p>
          ...
          <div className="flex items-start gap-2">
            <input type="hidden" name="agreeTerms" value={formData.agreeTerms ? "on" : "off"} />
            <Checkbox
              id="terms"
